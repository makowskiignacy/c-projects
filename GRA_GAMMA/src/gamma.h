...
/**
 * @brief Sprawdza, czy gracz może wykonać wskazany ruch.
 * @param g - aktualny stan gry, przechowany w strukturze
 * @param player - gracz dla, którego sprawdzana jest możliwość wykonania ruchu
 * @param x - numer kolumy
 * @param y - numer wiersza
 * @return prawdę, gdy gracz może wykonać wskazany ruch inaczej fałsz
 */
bool this_move_possible(gamma_t *g, uint32_t player, uint32_t x, uint32_t y);

/**
 * @brief Sprawdza, czy gracz może wykonać wskazany złoty ruch.
 * @param g - aktualny stan gry, przechowany w strukturze
 * @param player - gracz dla, którego sprawdzana jest możliwość wykonania ruchu
 * @param x - numer kolumy
 * @param y - numer wiersza
